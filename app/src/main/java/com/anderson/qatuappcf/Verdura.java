...
public class Verdura extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Verdura.this, Cliente.class);
                startActivity(i);
                finish();
            }
        });
        ...
        txtNom.setText("Verduras");
        searchView.setQueryHint("Buscar nombre de Verdura");
        ...
        Query query = firestore.collection("pro").whereEqualTo("tipo", "Verdura");

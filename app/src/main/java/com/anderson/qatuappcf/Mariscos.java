...
public class Mariscos extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Mariscos.this, Cliente.class);
                startActivity(i);
                finish();
            }
        });
        ...
        txtNom.setText("Mariscos");
        searchView.setQueryHint("Buscar nombre de Marisco");
        ...
        Query query = firestore.collection("pro").whereEqualTo("tipo", "Mariscos");

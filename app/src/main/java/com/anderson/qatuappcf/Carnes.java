...
public class Carnes extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Carnes.this, Cliente.class);
                startActivity(i);
                finish();
            }
        });
        ...
        txtNom.setText("Carnes");
        searchView.setQueryHint("Buscar nombre de Carne");
        ...
        Query query = firestore.collection("pro").whereEqualTo("tipo", "Carnes");
